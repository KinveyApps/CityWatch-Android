...
//	}
	...
	private void finishConfirmCredentials(boolean result) {
		final Account account = new Account(mUserEmail, KinveyService.ACCOUNT_TYPE);
		mAccountManager.setPassword(account, mPassword);
		mAccountManager.setUserData(account, KinveyService.LOGIN_TYPE_KEY, PARAM_LOGIN_TYPE_KINVEY);
	...
	private void finishLogin(String authToken) {
		...
		if (mRequestNewAccount) {
			...
			userData.putString(KinveyService.LOGIN_TYPE_KEY, PARAM_LOGIN_TYPE_KINVEY);
	...
	public void userLogin() {
		mKinveyClient.loginWithUsername(mEditUserEmail.getText().toString(), mEditPassword.getText().toString(), new KinveyCallback<KinveyUser>() {
	        ...
	        public void onSuccess(KinveyUser u) {
	            ...
	            LoginActivity.this.startActivity(new Intent(LoginActivity.this, CityWatchActivity.class));
	            LoginActivity.this.finish();
	        }
