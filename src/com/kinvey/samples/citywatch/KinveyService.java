...
public class KinveyService {
	...
	public static KinveyService getInstance(Context context) {
		if (instance == null) {
			...
			instance.ma = instance.mKinveyClient.mappeddata(CityWatchEntity.class, COLLECTION_NAME);
	...
	public void addEntity(CityWatchEntity curEvent, ScalarCallback<CityWatchEntity> callback) {
	...
	public void getCityWatchEntities(Location loc, double maxDistance, ListCallback<CityWatchEntity> callback) {
